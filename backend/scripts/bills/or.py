"""
bills/or.py — Oregon bill collector.

Source:  https://olis.oregonlegislature.gov
Auth:    none
Tier:    C (HTML scrape)
"""
...
STATE_CODE = "OR"
SOURCE = "or_leg"
PRIMARY_URL = "https://olis.oregonlegislature.gov"


def collect() -> list[dict]:
    # TODO: implement HTML scrape collector for Oregon
