"""
bills/ms.py — Mississippi bill collector.

Source:  https://billstatus.ls.state.ms.us
Auth:    none
Tier:    C (HTML scrape)
"""
...
STATE_CODE = "MS"
SOURCE = "ms_leg"
PRIMARY_URL = "https://billstatus.ls.state.ms.us"


def collect() -> list[dict]:
    # TODO: implement HTML scrape collector for Mississippi
