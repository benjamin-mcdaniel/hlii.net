"""
bills/ok.py — Oklahoma bill collector.

Source:  https://www.oklegislature.gov
Auth:    none
Tier:    C (HTML scrape)
"""
...
STATE_CODE = "OK"
SOURCE = "ok_leg"
PRIMARY_URL = "https://www.oklegislature.gov"


def collect() -> list[dict]:
    # TODO: implement HTML scrape collector for Oklahoma
