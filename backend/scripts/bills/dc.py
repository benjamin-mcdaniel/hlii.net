"""
bills/dc.py — District of Columbia bill collector.

Source:  https://lims.dccouncil.gov
Auth:    none
Tier:    C (HTML scrape)
"""
...
STATE_CODE = "DC"
SOURCE = "dc_leg"
PRIMARY_URL = "https://lims.dccouncil.gov"


def collect() -> list[dict]:
    # TODO: implement HTML scrape collector for District of Columbia
