"""
bills/nh.py — New Hampshire bill collector.

Source:  https://www.gencourt.state.nh.us
Auth:    none
Tier:    C (HTML scrape)
"""
...
STATE_CODE = "NH"
SOURCE = "nh_leg"
PRIMARY_URL = "https://www.gencourt.state.nh.us"


def collect() -> list[dict]:
    # TODO: implement HTML scrape collector for New Hampshire
