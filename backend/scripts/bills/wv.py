"""
bills/wv.py — West Virginia bill collector.

Source:  https://www.wvlegislature.gov
Auth:    none
Tier:    C (HTML scrape)
"""
...
STATE_CODE = "WV"
SOURCE = "wv_leg"
PRIMARY_URL = "https://www.wvlegislature.gov"


def collect() -> list[dict]:
    # TODO: implement HTML scrape collector for West Virginia
