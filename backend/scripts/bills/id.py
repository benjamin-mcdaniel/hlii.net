"""
bills/id.py — Idaho bill collector.

Source:  https://legislature.idaho.gov
Auth:    none
Tier:    C (HTML scrape)
"""
...
STATE_CODE = "ID"
SOURCE = "id_leg"
PRIMARY_URL = "https://legislature.idaho.gov"


def collect() -> list[dict]:
    # TODO: implement HTML scrape collector for Idaho
